...
public class AdjacencyEdgeListGraph<V> implements Graph<V> {
  ...
  protected List<List<Edge>> edges = new ArrayList<>(); // Store edges
...
//    }
 ...
 // @Override /** Add an edge to the graph */
  ...
  public boolean remove(V v) {
    ...
    List<Edge> incEdges = getIncidentEdges(v);
...
//      if (current.u > vertexIndex){
//        current.u--;
//      }
//      if (current.v > vertexIndex){
//        current.v--;
//      }
    }
...
//      Edge current = edges.get(i);
//      if ((u == current.u && v == current.v) || (v == current.u && u == current.v)){
//        edges.remove(current);
//        edges.remove(new Edge(v,u,current.e));
//        found = true;
//      }
      i++;
    }
